...
export default function Home() {
  return (
    <>
      ...
      {/* Core Mission */}
      <section className="bg-white py-32 md:py-48 px-8">
        <div className="max-w-screen-xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-24">
            <div className="md:col-span-12">
              <span className="text-primary font-semibold tracking-tight text-lg block mb-4">Core Mission</span>
              <h2 className="font-sans text-4xl md:text-6xl font-bold text-on-surface tracking-tight leading-tight max-w-4xl">
                Shaping the future of human-AI conversation through rigorous research.
              </h2>
            </div>
            <div className="md:col-span-8 md:col-start-1">
              <p className="text-xl md:text-2xl text-on-surface-variant leading-relaxed font-normal">
                Led by Prof. Lizi Liao at the School of Computing and Information Systems, Singapore Management University,
                CoAgent Lab is dedicated to building intelligent conversational agents that are proactive, empathetic, and
                grounded in multimodal understanding. Our work spans dialogue systems, knowledge-aware search, emotional support,
      ...
      <section className="bg-white py-32 md:py-48 px-8">
        <div className="max-w-screen-xl mx-auto">
          <div className="mb-24">
            <h2 className="font-sans text-4xl md:text-5xl font-bold tracking-tight max-w-2xl">
              Pioneering solutions in conversational intelligence.
            </h2>
          </div>
              ...
              <div key={area.id} className={`grid grid-cols-1 lg:grid-cols-2 gap-16 items-center`}>
                {i % 2 === 1 && (
                  <div className="order-2 lg:order-1">
                    ...
                    <Link href="/research" className="flex items-center gap-3 text-primary font-semibold group">
                      <span>Explore</span>
                      <span className="material-symbols-outlined transition-transform group-hover:translate-x-1">arrow_forward</span>
                    </Link>
                  </div>
                ...
                <div className={`overflow-hidden rounded-2xl bg-zinc-100 ${i % 2 === 1 ? 'order-1 lg:order-2' : ''}`}>
                  <div className="w-full aspect-[4/3] bg-gradient-to-br from-zinc-100 to-zinc-200 flex items-center justify-center">
